...
import { registrarFimAlmoco } from '@/lib/firebaseDb'
...
export async function POST(req: NextRequest) {
  try {
    ...
    return NextResponse.json({ 
      success: true, 
      horaFimAlmoco,
      message: 'Fim do almoço registrado com sucesso',
    ...
    console.error('Erro na API de fim do almoço:', error)
    
    const errorMessage = error instanceof Error ? error.message : 'Erro ao registrar fim do almoço'
